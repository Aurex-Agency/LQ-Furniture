...
**The Slogan Decal.** The client-supplied "Never pay retail again!" artwork (`public/brand/never-pay-retail.png`, black brush caps with a white outline and green offset) is a posted object like the signs, not a type treatment. It appears once, on the home hero photo top-left, entering with the `.slap-in` stamp (scale 1.35 to 1 on the site ease, 1400ms after the room lights). It must sit above the hero scrims, never be recolored or rebuilt in type, and never repeat elsewhere without a client ask.
