...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "A showroom with rugs and soft lighting and a coffee bar is lovely, and you pay for every bit of it in the furniture. Our building is a warehouse. The lights are bright, the floor is concrete, and the rent per square foot is a fraction of retail. That gap goes to you.",
  ...
  },
  {
    ...
    body: [
      ...
      "We're open Wednesday through Saturday 10 to 6 and Sunday 12 to 6. Fresh floor moves fastest at the front of that run, so Wednesday and Thursday shoppers get the widest pick. Saturday is the busiest day, and Sunday is the calmest.",
