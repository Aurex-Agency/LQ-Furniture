...
- Store facts (verified against the store's own Facebook posts and Google listing, Aug 2026): 589 North Coley Rd, Tupelo, MS 38801. Phone (662) 584-5282 (changed by the client September 2026). Open Wednesday through Saturday 10am to 6pm, Sunday 12pm to 6pm, closed Monday and Tuesday. Existing domain: lqfurniture.com.
...
- Weekly drop: /weekly-drop is the landing page for the weekly SMS blast. It is deliberately absent from the header and footer navigation (the way in is the text message) but is in the sitemap, since it is fresh local content. The client posts a Google Drive folder link and says "this week's drops"; the full procedure for turning that into a deployed page is docs/WEEKLY-DROP.md. Photos live in public/photos/drops/<weekOf>/ and the week's data is src/lib/drops.ts.
