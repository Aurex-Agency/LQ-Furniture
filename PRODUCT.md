...
- Typography (client asked for "better fonts", then rejected the grotesk subtext): one Caslon family. Libre Caslon Display for sentence-case display, Libre Caslon Text for body and the small engraved-caps labels. Archivo, Newsreader, DM Mono and Hanken Grotesk are all retired. Via next/font/google, latin subset.
- Visual world: the showroom at night (direction roll e1b2fdb5, third world). Premium after-hours retail: lit charcoal room, photographs presented like window displays with deep soft shadows, serif statements in sentence case, the amended sign family (live NeonSign, static signs, tube arrow), motion as lighting (lights up, settle, mask reveals, blur-to-sharp rises, neon flicker and buzz, scroll drift on large photos). Chosen after the client demanded a premium, unique, multi-page site with no cream; treat as standing until the client says otherwise.
