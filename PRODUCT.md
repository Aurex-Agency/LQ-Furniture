...
- Typography (fourth iteration, client asked for clean and professional with character): one family, Schibsted Grotesk with italic. Display at 800 set tight in sentence case, regular body, semibold small-caps labels. Archivo, Newsreader, DM Mono, Hanken Grotesk and both Caslons are retired. Via next/font/google, latin subset.
